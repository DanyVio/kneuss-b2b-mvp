...
describe("Check the Footer", function () {
  ...
  it("footer", function () {
    ...
    cy.get(".nav.item")
      .children()
      .contains("Güggeli / Poulet")
      .should("be.visible")
      .click();
    cy.scrollTo("bottom");
    cy.get(".nav.item")
      .children()
      .contains("Schnitzel / Brust")
      .should("be.visible")
      .click();
    cy.get(".nav.item")
      .children()
    ...
    cy.get(".nav.item")
      .children()
      .contains("Spezialitäten")
      .should("be.visible")
      .click();
    cy.get(".text-primary-lighter > a").should("be.visible").click();
    cy.get(":nth-child(2) > .footer > :nth-child(2) > a")
      .should("be.visible")
      .click();
    cy.get("#newsletter-subscribe").type("test@test.com");
    cy.get(".shrink-0").should("be.visible").click();
